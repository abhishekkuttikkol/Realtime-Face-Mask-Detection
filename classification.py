...
def main():
    ...
    while True:
        _, img = cap.read()
        predection, indexVal = maskClassifier.getPrediction(img)
        print(predection*100)
        cv2.putText(img, str(predection*100),
                        (10,100), cv2.FONT_HERSHEY_COMPLEX, 0.9, (0,255,0), 2)
